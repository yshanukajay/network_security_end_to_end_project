...
class TrainingPipelineConfig: 
    def __init__(self, timestamp: str = datetime.now()):
        ...
        self.final_model_dir = os.path.join(training_pipeline.FINAL_MODEL_DIR)
...
class DataTransformationConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.transformed_object_file_path : str = os.path.join(
            self.data_transformation_dir, training_pipeline.DATA_TRANSFORMATION_PREPROCESSOR_OBJECT_DIR, "preprocessor.pkl"
        )
